...
When('I add a new user with details username {string}, firstname {string}, lastname {string} and email {string}', (username,firstname,lastname,email) => {
    uEmail = randomId+email;
    fName = firstname +randomId;
    lName = lastname +randomId;
    uName = username +randomId;
    usersPage.addUserDetails(uName, fName, lName, uEmail);
});
